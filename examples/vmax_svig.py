...
profile="""
        SymCLI_ML
                Symmetrix
                    Symm_Info
                        symid = dataset:mydata dataset:toshow 
                    Masking_View
                        View_Info
                            ...
                            Initiator_List
                                Initiator
                                    group_name = dataset:mydata dataset:toshow
                                    wwn = dataset:mydata dataset:toshow
                                    user_node_name = dataset:mydata dataset:toshow
                                    user_port_name = dataset:mydata dataset:toshow
...
# df=pd.DataFrame.from_records(output['toshow'],columns=["symid","view_name","view_last_update_time","init_grpname","group_name","wwn","user_node_name","user_port_name","filename"])
